            ...
            <div class="col-sm-7">
                <div class="footer-delivery-adreess"><h3><a href="<?php echo e(url('/')); ?>">Bdshopping zone.</a></h3><span><a
                    ...
                    <span><a href="<?php echo e(url('/')); ?>/return-policy">Return Policy</a></span> <span><a
                                ...
                                href="<?php echo e(url('/')); ?>/sitemap">Sitemapp</a></span> <br> <span class="adreess"> 39 /a Islami Somaj Kollan Mosjid Goli Senpara Mirpur 10 Dhaka-1216</span>
...
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/jquery.number.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/jquery.validate.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/jquery.flexslider-min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/jquery.easing.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/jquery.touchSwipe.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/flipclock.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/jquery.liquid-slider.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/jquery.cookie.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/jquery.tweet.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/jquery.prettyPhoto.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/zoomsl-3.0.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/retina.min.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/custom.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/mycustom.js"></script>
 <script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/elevatezoom.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/lightslider.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/jquery.countdown.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/scroller.js"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/font_end/')); ?>/js/owl.carousel.js"></script>
...
<script type="text/javascript">
    ...
    jQuery('#search_query2').on('input change',function () {
        ...
        if (search_query.length >= 1) {
            ...
            jQuery.ajax({
                type:"POST",
                url: "<?php echo e(url('/')); ?>/home/product_search",
...
</html><?php /**PATH C:\SXampp\htdocs\bdshoppingzon\resources\views/website/includes/footer.blade.php ENDPATH**/ ?>