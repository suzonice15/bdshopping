                                    ...
                                    <div class="table-responsive">
                                        <table class="table  table-bordered">
                                            ...
                                            <tr id="<?php echo e($row->id); ?>">
                                                ...
                                                <td>
                                                    <span id="per_poduct_price">  <?php echo '৳' . $row->price; ?></span>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
													<span class="bold">
														...
														<span id="subtotal_cost"> <?php echo '৳' . $subTotal; ?>
...
<?php echo $__env->make('website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SXampp\htdocs\bdshoppingzon\resources\views/website/checkout.blade.php ENDPATH**/ ?>