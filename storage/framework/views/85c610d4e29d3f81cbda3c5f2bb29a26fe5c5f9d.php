...
<?php $__env->startSection('mainContent'); ?>
    ...
    <div class="box-body">
        ...
        <div class="col-sm-offset-0 col-md-12">
            <form  name="vendor" action="<?php echo e(url('admin/vendor/edit/update')); ?>/<?php echo e($vendor->vendor_id); ?>" class="form-horizontal"
                   method="post"
                ...
                <div class="box" style="border: 2px solid #ddd;">
                            ...
                            <div class="col-md-6 col-sm-12" style="margin-left: 100px">
                                <div class="form-group">
                                    ...
                                    <input required="" type="text" id="vendor_percent" class="form-control the_title"
                                           name="vendor_percent" value="<?php echo e($vendor->vendor_percent); ?>">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row" style="margin-left: 5px;">
                        <div class="col-md-6 col-sm-6 zoomin">
                           <?php if($vendor->nid_image): ?>
                            <a href="#" id="pop">
                                <img id="imageresource" src="<?php echo e(URL::to('/public')); ?>/uploads/users/<?php echo e($vendor->nid_image); ?>" style="width: 200px; height: 164px;">
                            </a>
                        ...
                        <div class="col-md-6 col-sm-6 zoomin" >
                            <?php if($vendor->bank_image): ?>
                              <a href="#" id="pop1">
                                <img id="imageresource1" src="<?php echo e(URL::to('/public')); ?>/uploads/users/<?php echo e($vendor->bank_image); ?>" style="width: 200px; height: 164px;">
                              ...
                              <div class="panel panel-success">
                                  ...
                                  <div class="panel-body">
                                          <div class="form-group">
                                              ...
                                              <label><?php echo e($vendor->m_name); ?></label>
                                          </div>
                                          <div class="form-group">
                                              <label for="ac_number">Ac Number:</label>
                                              <label><?php echo e($vendor->m_number); ?></label>
                                          </div>
                                          <div class="form-group">
                                              <label for="ac_type">Ac Type:</label>
                                              <label><?php echo e($vendor->m_type); ?></label>


                                          </div>
                                          <div class="form-group">
                                              <label for="service_name">Service Name:</label>
                                              <label><?php echo e($vendor->m_service); ?></label>
                                          </div>
                              ...
                              <div class="panel panel-success">
                                  ...
                                  <div class="panel-body">
                                      <div class="panel-body">
                                              ...
                                              <div class="form-group">
                                                  <label for="ac_name">Ac Name:</label>
                                                 <label><?php echo e($vendor->b_name); ?></label>
                                              </div>
                                              <div class="form-group">
                                                  <label for="ac_number">Ac Number:</label>
                                                 <label><?php echo e($vendor->b_number); ?></label>
                                              </div>
                                              <div class="form-group">
                                                  <label for="ac_branch">Branch Name:</label>
                                                  <label><?php echo e($vendor->b_branch); ?></label>
                                              </div>
                                              <div class="form-group">
                                                  <label for="bank_name">Bank Name:</label>
                                                  <label><?php echo e($vendor->b_bank); ?></label>
                                              </div>
                                      </div>
                                  </div>
                              </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SXampp\htdocs\bdshoppingzon\resources\views/admin/vendor/vendor_user_edit.blade.php ENDPATH**/ ?>