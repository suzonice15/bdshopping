<?php $__env->startSection('mainContent'); ?>
            ...
            <div class="innerbox">
                <div id="bannerSlider" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="item"><img src="https://www.dhakabaazar.com/uploads/gf-min.png"
                                               alt="Dhaka Image Slider"></div>
                        <div class="item active"><img src="https://www.dhakabaazar.com/uploads/karoki-min.png"
                                                      alt="Dhaka Image Slider"></div>
                        <div class="item"><img src="https://www.dhakabaazar.com/uploads/hotshower-1-2-min.png"
                                               alt="Dhaka Image Slider"></div>
                        <div class="item"><img src="https://www.dhakabaazar.com/uploads/toyzone-min.png"
                                               alt="Dhaka Image Slider"></div>
                        <div class="item"><img src="https://www.dhakabaazar.com/uploads/banner-4-min.png"
                                               alt="Dhaka Image Slider"></div>
                        <ol class="carousel-indicators">
                            <li data-target="#bannerSlider" data-slide-to="0" class="">&nbsp;</li>
                            <li data-target="#bannerSlider" data-slide-to="1" class="active">&nbsp;</li>
    ...
    <div class="container remove_class"
        ...
        <div class="category-tabs" style="margin-top: 9px; border-bottom: 3px solid darkmagenta; margin-left: -14px;"><a
                    class="parent"
                    style="background-color: rebeccapurple; padding: 4px 19px; color: white; margin: 22px -3px auto; margin-bottom: auto; margin-bottom: auto; height: 59px; margin-bottom: -29px; font-size: 16px; border-radius: 6px;"
...
<?php echo $__env->make('website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SXampp\htdocs\bdshopping\resources\views/website/home.blade.php ENDPATH**/ ?>