...
(function($) {
    ...
    FlipClock.DailyCounterFace = FlipClock.Face.extend({
        ...
        build: function(excludeHours, time) {
            ...
            if(this.showSeconds) {
                $(this.createDivider('Secs')).insertBefore(this.factory.lists[this.factory.lists.length - 2].$obj);
            }
            else
            {
                offset = 2;
            ...
            $(this.createDivider('Mins')).insertBefore(this.factory.lists[this.factory.lists.length - 4 + offset].$obj);
