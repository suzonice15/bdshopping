...
<footer id="footer">
    <div class="container">
        <div class="row">
            <div class="col-sm-7">
                <div class="footer-delivery-adreess"><h3><a href="{{url('/')}}">Bdshopping zone.</a></h3><span><a
                ...
                <div class="footer-delivery-adreess"><h3 style="color:#F2F2F2;">Payment</h3> <span><a
                                href="{{url('/')}}/replacementpolicy">Replacement Policy</a></span> <span><a
                                href="{{url('/')}}/refundpolicy">Refund Policy</a></span> <span><a
                                href="{{url('/')}}/customercomplain">Complain</a></span>
                ...
                <div class="footer-p-delivery-adreess">
                    <div class="footer-delivery-adreess"><h3 style="color:#F2F2F2;">We Accept</h3> <span
                                style="text-align:center;">Cash On Delivery</span> <span><img
                                    src="{{url('/')}}/images/footer-cod.png" alt=""></span> <span><img
                                    src="{{url('/')}}/images/footer-bkash.png" alt=""></span> <span><img
                                    src="{{url('/')}}/images/footer-bdbl.png" alt=""></span> <span><img
                                    src="{{url('/')}}/images/footer-visa.png" alt=""></span> <span><img
                                    src="{{url('/')}}/images/footer-mastercard.png" alt=""></span> <span><img
                                    src="{{url('/')}}/images/amex.png" alt="#"></span>
                        <div class="footer-border"></div>
                    </div>
                </div>
                ...
                <div class="fotter-right-area">
                    ...
                    <div class="footer-ques-complain">
                        <div class="thuumbnail"><a href="#"><span><img
                                            src="{{url('/')}}/images/footer-ques.png" alt="#"> Question</span></a> <a
                                    href="#"><span><img src="{{url('/')}}/images/footer-opinion.png" alt="#"> Comment</span></a>
                            <a href="#"><span><img src="{{url('/')}}/images/footer-complain.png" alt="#"> Complain</span></a>
                        </div>
                    </div>
                    ...
                    <div class="footer-copyright"><span>© Copyright- Bdshopping zone 2020 || Powered By <a
                                    href="{{url('/')}}" target="_blank">Bdshopping zone.</a><br><br></span></div>
                </div>
            </div>
        </div>
        <br>
...
<aside id="minicart">
    ...
    <div class="innerbox">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                <td colspan="3" class="cart-action"><a href="{{url('/')}}" style="width:100%">Shop
                        Now</a></td>
            </tr>
        </table>
    </div>
