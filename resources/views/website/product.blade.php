        ...
        <div class="container-fluid">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    ...
                    <?php } ?>
                    <li><a href="{{url('/category/')}}/{{$category_name_last}}">{{$category_title_last}}</a></li>
                    ...
                    <div class="row">
                        <div id="desktop_picture" class="col-sm-4 images">
                            <img id="singleProduct_picture"
                                 ...
                                 data-zoom-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->feasured_image }}">
                            <img id="zoom_09"
                                 src="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->feasured_image }}"
                                 data-zoom-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->feasured_image }}">
                            <div id="gallery_09">
                                <div id="gallery_09" style="max-width: 1200px; margin-left: -6px;">
                                    ...
                                    <a  href="javascript:void(0)" class="elevatezoom-gallery"
                                                                     data-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->feasured_image }}"
                                                                     data-zoom-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->feasured_image }}"><img
                                                src="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->feasured_image }}"
                                                width="200"></a>

                                        <a  href="javascript:void(0)" class="elevatezoom-gallery"
                                            data-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_1 }}"
                                            data-zoom-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_1 }}"><img
                                    ...
                                    <?php }?>
                                        ...
                                        <a  href="javascript:void(0)" class="elevatezoom-gallery"
                                            data-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_2 }}"
                                            data-zoom-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_2 }}"><img
                                        ...
                                        <a  href="javascript:void(0)" class="elevatezoom-gallery"
                                            data-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_3 }}"
                                            data-zoom-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_3 }}"><img
                                        ...
                                        <a  href="javascript:void(0)" class="elevatezoom-gallery"
                                            data-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_4 }}"
                                            data-zoom-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_4 }}"><img
                                        ...
                                        <a  href="javascript:void(0)" class="elevatezoom-gallery"
                                            data-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_5 }}"
                                            data-zoom-image="{{ url('/public/uploads') }}/{{ $product->folder }}/{{ $product->galary_image_5 }}"><img
                        ...
                        <div class="col-sm-5 mt40column"><h1 class="headinglefttitle">{{$product->product_title}}</h1>
                            <p class="sku">Product Code: {{$product->sku}}</p>
                            <div class="price-and-cart">
                                <div class="prices"> <div class="addreview">
                                    ...
                                    ?>
                                    <del class="bn"> @money($product->product_price)</del>

                                    <?php } else {   $sell_price = $product->product_price;  } ?>


                                    <span class="bn"> @money($sell_price)</span>
                                </div>
                                    ...
                                    <form action="" method="POST" id="" enctype="multipart/form-data"><br>
                                        <div class="btns">
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-primary add_to_cart"
                                               data-product_id="{{ $product->product_id}}" data-picture="{{ url('/public/uploads') }}/{{ $product->folder }}/small/{{ $product->feasured_image}}" >Add
                                                to Cart</a> <a href="javascript:void(0)" class="btn btn-primary buy_now"
                                                               data-product_id="{{ $product->product_id}}" data-picture="{{ url('/public/uploads') }}/{{ $product->folder }}/small/{{ $product->feasured_image}}" >Order
                                                Now</a></div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-3 col-optional">
                            <div class="vertical-menu">
                                ...
                                <a class="active" target="_blank"
                                                          href="{{url('/')}}/category/{{$category_name_first}}">{{$category_title_first}} </a>
                                ...
                                @if($categories_right)
                                    @foreach($categories_right->unique('category_name') as $right_cat)

                                   <a target="_blank" href="{{url('/')}}/category/{{$right_cat->category_name}}"> {{$right_cat->category_title}}</a>
